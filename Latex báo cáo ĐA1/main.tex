...
\begin{titlepage}
	...
	\begin{center}
		...
		{\bfseries\fontsize{24pt}{28pt}\selectfont ĐỒ ÁN I\par}
		% Nếu thầy yêu cầu ghi đúng như mẫu thì đổi dòng trên thành:
		% {\bfseries\fontsize{24pt}{28pt}\selectfont ĐỒ ÁN TỐT NGHIỆP\par}
		
		\vspace{1cm}
		
		{\bfseries\fontsize{18pt}{24pt}\selectfont
			Phân tích doanh số và xu hướng tiêu dùng khách hàng trong lĩnh vực bán lẻ }
		
		\vspace{1cm}
		
		{\bfseries\Large NGUYỄN HỮU NHẬT ANH\par}
		
		{\normalsize \texttt{ANH.NHN237412@sis.hust.edu.vn}\par}
		
	
		{\bfseries Ngành Hệ thống Thông tin Quản lý\par}
		{\bfseries Chuyên ngành Phân tích dữ liệu\par}
	\end{center}
	\vspace{0.5cm}
	\vfill
	
	\noindent
\begin{tabular}{@{}p{4.3cm}p{7cm}p{4.2cm}@{}}
	\textbf{Giảng viên hướng dẫn:} 
	& TS. Đoàn Duy Trung 
	& \centering \rule{4cm}{0.4pt} \tabularnewline[-0.1cm]
	
	& 
	& \centering {\footnotesize Chữ ký của GVHD} \tabularnewline[0.3cm]
