...
output_dir = r"D:\HUST-MI2\2025.2\Đồ án 1-Thầy Đoàn Duy Trung\Model_Output\XGBoost_Sau_Ngoai_Lai"
...
cap_info_X.to_csv(os.path.join(output_dir, "xgboost_after_outlier_capping_info_X.csv"), index=False, encoding="utf-8-sig")
cap_info_y.to_csv(os.path.join(output_dir, "xgboost_after_outlier_capping_info_y.csv"), index=False, encoding="utf-8-sig")
...
plt.title("XGBoost sau xử lý ngoại lai: Actual vs Predicted")
plt.grid(True)
save_fig("xgboost_after_actual_vs_predicted.png")
...
plt.xlabel("Sai số")
plt.ylabel("Tần suất")
plt.title("Phân bố sai số của XGBoost sau xử lý ngoại lai")
plt.grid(True)
save_fig("xgboost_after_residual_distribution.png")
...
plt.ylabel("Biến")
plt.title("Top 10 biến quan trọng nhất - XGBoost sau xử lý ngoại lai")
plt.grid(True)
save_fig("xgboost_after_feature_importance.png")


# 11. LƯU KẾT QUẢ

result.to_csv(os.path.join(output_dir, "xgboost_after_predictions.csv"), index=False, encoding="utf-8-sig")
importance_df.to_csv(os.path.join(output_dir, "xgboost_after_feature_importance.csv"), index=False, encoding="utf-8-sig")
...
metrics_df.to_csv(os.path.join(output_dir, "xgboost_after_metrics.csv"), index=False, encoding="utf-8-sig")
