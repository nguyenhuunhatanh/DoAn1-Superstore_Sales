...
plt.xlabel("Sai số")
plt.ylabel("Tần suất")
plt.title("Phân bố sai số của mô hình")
plt.grid(True)
plt.show()

plt.figure(figsize=(8, 6))
stats.probplot(errors, dist="norm", plot=plt)
plt.title("QQ Plot của phần dư")
plt.grid(True)
plt.show()

result.to_csv("linear_regression_predictions.csv", index=False, encoding="utf-8-sig")
coef_df.to_csv("linear_regression_coefficients.csv", index=False, encoding="utf-8-sig")
...
metrics_df.to_csv("linear_regression_metrics.csv", index=False, encoding="utf-8-sig")
